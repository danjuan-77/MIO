...
def create_clip_vit_L(img_size=224, use_checkpoint=False, precision="fp16", model_root_dir='models'):
    ...
    cached_file_path = os.path.join(model_root_dir, 'clip_vit_L.pth')
