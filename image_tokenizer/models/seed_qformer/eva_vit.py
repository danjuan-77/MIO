...
def create_eva_vit_g(img_size=224, drop_path_rate=0.4, use_checkpoint=False, precision="fp16", model_root_dir='models'):
    ...
    cached_file_path = os.path.join(model_root_dir, 'eva_vit_g.pth')
